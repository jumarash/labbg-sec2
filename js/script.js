...
let theMsg = document.querySelector('.colour ')
let theBtn = document.querySelector('.randomCol')
    ...
    let setNewColour = function() {
        ...
        theBody.setAttribute(`style`, `background-color: rgb(${redCol},${greenCol},${blueCol})`)
        
        theMsg.textContent = `rgb(${redCol},${greenCol},${blueCol})`
         }

theBtn.addEventListener('mousemove', setNewColour)        
